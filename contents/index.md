...
titleTemplate: 'A curated collection of prompts for ChatGPT, Claude, and other LLMs'

hero:
  name: 'Useful AI Prompts'
  # text: 'Prompts I reach for, ready to copy'
  tagline: 'Make AI work smarter with these ready-to-use prompts!'
  actions:
    - theme: brand
...
features:
  ...
  - title: 🎨 UX Copy
    details: Generate alternative wordings for UX copy
    link: /ux-copy-related
  - title: 🌐 Translation
    details: Translate between languages while preserving formatting and structure
  ...
  - title: 💬 Slack Cleanup
    details: Turn a messy Slack thread into a clean Markdown file
    link: /slack-related
